...
The app prestends to connect to the attached mobile network, allows the  user to enter a number a plays dial/MF/ringing tones. The app then plays a .WVE file that sounds like someone has picked up/answered the call. A file with this name can be recorded/customised so you can have whoever/whatever you like answering your fake call :-D
